...
public final class EntityManagers
{
    ...
    {
    	System.out.println("from newEntityManager url"+  dbConfig.getDatabaseUrl() );
    ...
    {
    	System.out.println("newEntityManager is :   "+persistenceUnit + "   and  properties " + properties);
    	
    	final EntityManagerFactory emf = Persistence.createEntityManagerFactory(persistenceUnit,
                properties);
    	
    	System.out.println("createEntityManagerFactory After");
